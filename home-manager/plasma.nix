{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "services/switch-to-dark-theme.sh.desktop"."_launch" = "Ctrl+F12";
    ...
    configFile = {
      ...
      "kwinrc"."Tiling/ec115ba5-57d7-5ed3-814a-1fcddfc3feab"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
