{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "kcm_touchpad"."Disable Touchpad" = "\\, Touchpad Off,Touchpad Off";
      "kcm_touchpad"."Enable Touchpad" = "\\, Touchpad On,Touchpad On";
      "kcm_touchpad"."Toggle Touchpad" = ["\\, Touchpad Toggle" "Meta+Ctrl+Zenkaku Hankaku,Touchpad Toggle" "Meta+Ctrl+Zenkaku Hankaku"];
      "kmix"."decrease_microphone_volume" = "Ctrl+Volume Down\\, Microphone Volume Down,Microphone Volume Down,Decrease Microphone Volume";
      "kmix"."decrease_volume" = "Volume Down";
      "kmix"."decrease_volume_small" = "Shift+Volume Down";
      "kmix"."increase_microphone_volume" = "Ctrl+Volume Up\\, Microphone Volume Up,Microphone Volume Up,Increase Microphone Volume";
      ...
      "kwin"."Edit Tiles" = "Meta+Y\\, Meta+T,Meta+T,Toggle Tiles Editor";
      "kwin"."Expose" = "Ctrl+F9";
      ...
      "org_kde_powerdevil"."Sleep" = "\\, Sleep\\, Suspend,Sleep,Suspend";
    ...
    configFile = {
      ...
      "kcminputrc"."Libinput/1133/50504/Logitech USB Receiver Mouse"."ScrollFactor" = 0.3;
