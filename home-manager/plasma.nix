{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "kwin"."Window Lower" = [ ];
      "kwin"."Window Maximize" = ["Alt+Up" "Meta+PgUp,Meta+PgUp,Maximize Window"];
      ...
      "plasmashell"."cycleNextAction" = "\\, ,,Next History Item";
    ...
    configFile = {
      ...
      "kcminputrc"."Libinput/1133/50504/Logitech USB Receiver Mouse"."ScrollMethod" = 4;
      ...
      "kwinrc"."Tiling/80f152f6-6f99-533e-a971-0dadb3e879d1"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/f441719b-d1f1-5819-8c11-57faf55c7fc1"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
